...
<h4><img src="{{ '/assets/images/online.svg' | relative_url }}" alt="线上会议" class="emoji-svg" /> 线上会议</h4>
<p>具体信息待定</p>
  ...
  <section class="info-card">
    ...
    <div class="card-body">
      ...
      <ul class="news-list" aria-label="会议新闻列表">
          ...
          <div class="news-item">
            会议被初步决定在2025年12月07日举行，可能的讲座内容见 <a href="{{ '/zh/agenda/' | relative_url }}">会议议程页面</a>。
          </div>
        </li>
        <li>
          ...
          <div class="news-item">
            请参会者尽快填写
            <a href="https://v.wjx.cn/vm/muy9ycH.aspx" target="_blank" rel="noopener noreferrer">问卷</a>
            ，以便我们尽快组织会议。
          </div>
        </li>
        <li>
          ...
          <div class="news-item">
            <a href="{{ '/zh/' | relative_url }}" target="_blank" rel="noopener noreferrer">会议网站</a>
